...
// ¿Dónde pondrías la población mundial actual?
        long poblacionMundialActual; // Usar 'long' para números muy grandes
...
// ¿Dónde guardarías la hora exacta de un evento?
        String horaExactaEvento; // O un tipo de dato de hora específico, como LocalTime en Java 8+
...
// ¿Qué variable usarías para el identificador único de un cliente?
        String identificadorUnicoCliente;
